...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profil) {
            ...
            fragmentManager.beginTransaction().replace(R.id.content_frame, new com.example.fitcometv3.AtlasFragment()).addToBackStack(null).commit();
    ...
    public void AtlasBicepsClick(View view) {
        Toast.makeText(this, "Biceps!", Toast.LENGTH_LONG).show();
    }

    public void AtlasOnBarkClick(View view) {
        Toast.makeText(this, "BARK!", Toast.LENGTH_LONG).show();
    }
}
